...
with st.container(border=True): # Ajoute une bordure visuelle autour de cette section
    ...
    # Utilisation correcte de dfs['usertcode'] comme source initiale
    df_user_original = dfs['usertcode'].copy()
    ...
    if df_user_filtered.empty:
        ...
        # La colonne de temps de réponse est bien 'RESPTI'
        ...
        if 'TASKTYPE' in df_user_filtered.columns and 'RESPTI' in df_user_filtered.columns:
            ...
            # Utilise df_user_filtered pour cette opération car le DataFrame est déjà filtré
            ...
            # Utilise df_user_filtered['RESPTI'] pour le calcul
